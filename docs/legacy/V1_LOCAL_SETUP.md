# UrbanSync v1 — Local Development Setup (Legacy)

> This describes the **original v1 single-process Node.js + MongoDB** setup, kept for historical reference only.
> The current production system is UrbanSync v2 — see [`urbansync-v2/README.md`](../../urbansync-v2/README.md) for the live Cloud-Native architecture, deployment, and operations docs.
